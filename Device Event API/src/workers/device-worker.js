...
// CORREÇÃO:
// Modificação do deviceLoops para devices (Map correto definido na linha 15)
// loop para 'timeoutId' no destructuring (nome mais claro e correto)
// Agora todos os timeouts são cancelados corretamente antes do shutdown
async function shutdown() {
  console.log('Worker shutting down...');
  // Itera sobre todos os devices ativos e cancela seus timeouts
  for (const [deviceId, timeoutId] of devices.entries()) {
    clearTimeout(timeoutId);
  }
  devices.clear();
